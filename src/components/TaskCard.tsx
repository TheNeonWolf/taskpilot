                ...
                <div className="flex flex-col items-end gap-2">
                    ...
                    {onDelete && (
                        <button
                            ...
                            className="cursor-pointer rounded-lg border border-red-200 p-2 text-red-500 transition hover:bg-red-50 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950"
                        >
                            <Trash2 size={15} />
                        </button>
                    )}
